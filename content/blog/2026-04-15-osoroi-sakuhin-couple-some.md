...
気軽に楽しむなら「簡単絞り染めコース」(一人1,500円（税別）、約1時間)で、トートバッグや巾着をお揃いにするのもよいでしょう。じっくり取り組むなら「傘巻き絞りコース」(一人2,300円（税別）から、2時間〜2時間30分)で、京都の伝統工芸・鹿の子絞りの一種にペアで挑戦できます。料金や所要時間は時期により変わる場合がありますので、ご予約時にご確認ください。コースの詳細は[体験内容](/experience)でご覧いただけます。
