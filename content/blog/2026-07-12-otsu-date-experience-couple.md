...
デートにおすすめなのは「ストール染めコース」です。約1時間で、色を混ぜたりグラデーションにしたりと、自分たちの好みを反映させた一枚が仕上がります。一人2,800円からで、二人で異なる色を選んでもよし、同じテーマで色の濃淡を変えてもよし。完成後は当日持ち帰りでき、その後の日常で何度も手に取る度に、デートの思い出がよみがえります。
...
料金は選ぶコースによって異なります。「簡単絞り染めコース」は一人1,500円、「ストール染めコース」は一人2,800円から、「傘巻き絞りコース」は一人2,300円からが目安ですが、詳細は予約時に確認することをお勧めします。
