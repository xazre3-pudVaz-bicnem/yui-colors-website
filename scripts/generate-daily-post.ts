...
- コースA「簡単絞り染めコース」: 5・6歳〜、一人1,500円、約1時間。輪ゴムやビー玉など身近な素材でトートバッグや巾着を絞り染め
- コースB「ストール染めコース」: 5・6歳〜、一人2,800円〜、約1時間。色を混ぜたりグラデーションにしたり
- コースC「傘巻き絞りコース」: 小学5・6年生〜、一人2,300円〜、2時間〜2時間30分（時間枠2枠）。京都の伝統工芸・鹿の子絞りの一種に気軽にチャレンジできる
