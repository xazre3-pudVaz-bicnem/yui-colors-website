...
export const metadata: Metadata = createMetadata({
  ...
  description:
    "染め体験が初めての方へ。不器用でも大丈夫な理由、服装や持ちもの、当日の流れなど、大津市の染め工房 染 YUI COLORSを安心して楽しむための案内です。",
  path: "/beginner",
  keywords: [
    "染め体験 初めて",
    "大津市 体験教室",
...
const worries = [
  {
    question: "不器用だけど、大丈夫？",
    answer:
      "染め体験は、絵を描く体験ではありません。色を選び、布に移していく体験です。手順はひとつずつご案内しますし、むらや偶然できる模様はそのまま作品の味わいになります。器用さより、色を選ぶ楽しさが大切です。",
  },
  {
    question: "何を持っていけばいい？",
    answer:
  ...
  },
  {
    ...
    answer:
      "簡単絞り染めコースとストール染めコースは約1時間、傘巻き絞りコースは2時間〜2時間30分が目安です。観光の予定に合わせたい方は、予約時に旅程をお知らせください。",
  },
  {
    question: "ひとりでも参加できる？",
    answer:
        ...
        <div className="mx-auto max-w-3xl px-5">
          <Reveal>
            ...
            <div className="space-y-5 text-sm leading-loose text-ink/75 md:text-base">
              ...
              <p>
                染料が布に染み込んでいく様子は、思いどおりにならないからこそ美しいもの。狙っていなかった模様や濃淡が、世界にひとつだけの表情になります。
              </p>
              <p>
